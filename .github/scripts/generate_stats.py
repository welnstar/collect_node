...
<body>
    ...
    <div class="footer">
        <p>Generated by GitHub Actions | Branch: {git_info['branch']} | Commit: {git_info['commit_hash']}</p>
...
def main():
    ...
    # 生成 HTML 报告
    output_dir = 'stats'
    generate_html_report(stats_data, output_dir)
    print(f"HTML 报告已生成到 {output_dir} 目录")
